    ...
    if test_mode:
        return {
            ...
            "summary": [
                ...
                "Table 구조로 Gmail, Outlook 등 모든 메일 클라이언트에서 동일하게 표시됩니다.",
                "내용의 길이가 달라도 이미지와 텍스트 영역이 깔끔하게 정렬됩니다."
            ],
            "category": "테스트분야"
        }
...
<table width="850" cellpadding="0" cellspacing="0" style="background-color:#ffffff; padding:20px; font-family:'Malgun Gothic', sans-serif;">
    ...
    <td style="border-bottom:2px solid #005BAC; padding-bottom:10px;">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td align="right" style="font-size:24px; color:#005BAC; font-weight:bold; vertical-align:middle;">PNUTH Newsletter</td>
        </tr>
      </table>
    </td>
  </tr>
  ...
  <tr>
    <td style="padding-bottom:20px;">
      <h2 style="color:#005BAC; margin:0 0 5px 0; font-size:26px;">부산대학교 산학협력단 우수 특허/기술 리스트</h2>
  ...
  <tr><td style="padding-top:10px;">
    ...
    <table width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #ddd; border-radius:10px; margin-bottom:12px; background-color:#ffffff;">
      <tr>
        <td width="220" valign="middle" style="width:220px; padding:8px; border-right:1px solid #eee; background-color:#fafafa; text-align:center; vertical-align:middle;">
          <img src="{{ patent.image_url }}" width="200" height="180" style="width:200px; height:180px; object-fit:contain; border-radius:6px; border:1px solid #eee; background-color:#fff; display:block; margin:0 auto;">
        </td>
        <td valign="top" style="padding:15px 18px; vertical-align:top;">
          ...
          <p style="margin:0 0 5px 0; font-size:14px; line-height:1.6; color:#333; word-break:keep-all;">&#8226; {{ s }}</p>
          {% endfor %}
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          <td align="center" style="padding-bottom:12px;">
            <a href="{{ consult_url }}" style="display:inline-block; width:400px; background-color:#ffffff; color:#005BAC; text-decoration:none; padding:15px 0; border-radius:8px; font-weight:bold; border:2px solid #005BAC; font-size:16px; text-align:center;">&#128161; 수요기술 상담신청</a>
          </td>
        </tr>
        <tr>
          <td align="center">
            <a href="{{ pr_url }}" style="display:inline-block; width:400px; background-color:#555555; color:#ffffff; text-decoration:none; padding:15px 0; border-radius:8px; font-weight:bold; font-size:16px; text-align:center;">&#128250; PNUTH 홍보 채널 바로가기</a>
          </td>
        </tr>
      </table>
    </td>
